namespace Incasso.Migrations
{
    ...
    public partial class SetupQA : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                {
                    { "DynamicFilter_Administrator_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .Index(t => t.IsDeleted);
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Debtor_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                ...
                c => new
                    {
                        ...
                        PaidClient = c.Single(),
                        Interest = c.Single(),
                        CollectionFee = c.Single(),
                        AdminCosts = c.Single(),
                        Status = c.Int(nullable: false),
                        Closed = c.Boolean(nullable: false),
                        DisputeAction = c.String(),
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_InvoiceNote_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Upload_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .Index(t => t.IsDeleted);
                ...
                c => new
                    {
                        ...
                        OutSourcing = c.Boolean(nullable: false),
                        Incasso = c.Boolean(nullable: false),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.User_Id, t.Administrator_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Invoices", "User_Id", "dbo.AbpUsers");
            ...
            DropForeignKey("dbo.UserAdministrators", "Administrator_Id", "dbo.Administrators");
            DropForeignKey("dbo.UserAdministrators", "User_Id", "dbo.AbpUsers");
            DropForeignKey("dbo.Invoices", "UploadId", "dbo.Uploads");
            ...
            DropForeignKey("dbo.InvoiceNotes", "InvoiceId", "dbo.Invoices");
            DropForeignKey("dbo.Invoices", "DebtorId", "dbo.Debtors");
            DropForeignKey("dbo.Invoices", "AdministratorId", "dbo.Administrators");
            DropForeignKey("dbo.Debtors", "AdministratorId", "dbo.Administrators");
            DropIndex("dbo.UserAdministrators", new[] { "Administrator_Id" });
            DropIndex("dbo.UserAdministrators", new[] { "User_Id" });
            DropIndex("dbo.UploadAdministrators", new[] { "Administrator_Id" });
            DropIndex("dbo.UploadAdministrators", new[] { "Upload_Id" });
            ...
            DropIndex("dbo.Uploads", new[] { "IsDeleted" });
            DropIndex("dbo.InvoiceNotes", new[] { "IsDeleted" });
            DropIndex("dbo.InvoiceNotes", new[] { "InvoiceId" });
            DropIndex("dbo.Invoices", new[] { "User_Id" });
            DropIndex("dbo.Invoices", new[] { "IsDeleted" });
            DropIndex("dbo.Invoices", new[] { "AdministratorId" });
            DropIndex("dbo.Invoices", new[] { "DebtorId" });
            DropIndex("dbo.Invoices", new[] { "UploadId" });
            DropIndex("dbo.Debtors", new[] { "IsDeleted" });
            DropIndex("dbo.Debtors", new[] { "AdministratorId" });
            DropIndex("dbo.Administrators", new[] { "IsDeleted" });
